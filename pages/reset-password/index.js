...
import { Typography, Button, Box, TextField, Card, CircularProgress } from "@mui/material";
        ...
        >
            <Card sx={{ maxWidth: { md: '500px' }, width: '100%', px: 1, py: 1 }}>
                ...
                <Typography
                    variant="caption"
                    component="p"
                    sx={{ maxWidth: '300px', backgroundColor: '#f5f5f5', px: 1, py: 1, mb: 2 }}
                >
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Box sx={{ mt: 2 }}>
                        <Button
                            ...
                            type="submit"
                        >
                            {isLoading ? <CircularProgress sx={{ color: '#fff' }} /> : 'Reset Password'}
                        </Button>
                    </Box>
                </form>
