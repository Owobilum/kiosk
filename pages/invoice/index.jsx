    ...
    >
      <Grid container justifyContent="space-between">
        <Grid item xs={12} md={6}>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: { md: 4 } }}>
            <Box>
              <Image src="/kiosk.png" alt="kiosk logo" height={60} width={60} />
            </Box>
            <Box>
        ...
        <Grid item xs={12} md={6} sx={{ textAlign: { md: 'right' } }}>
          ...
          <Typography>
            <span style={classes.bold}>Date:</span> {orderDetails?.date}
          </Typography>
          <Typography>
            <span style={classes.bold}>Order Number:</span> {orderDetails?.id}
          </Typography>
          <Typography>
            <span style={classes.bold}>Payment Reference: </span>
            {orderDetails?.paymentReference}
          </Typography>
          <Typography>
            <span style={classes.bold}>Customer Name:</span> {displayName}
          </Typography>
          <Typography>
            <span style={classes.bold}>Customer Address:</span> {address}
          </Typography>
        </Grid>
      </Grid>
      ...
      <Box sx={{ textAlign: 'right', py: 4 }}>
        <Typography variant="h5">
          <span
            style={{ backgroundColor: '#fcfcfc', padding: 8, fontWeight: 600 }}
          >
